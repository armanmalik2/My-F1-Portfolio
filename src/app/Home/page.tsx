...
const Home1 = () => {
    return(
        <div className="">
            <div className="h-[90vh] flex justify-around items-center relative z-1 text-white">
                    <div className="Body-Text-Container flex flex-col text-center justify-evenly ">
                        ...
                        <div className="flex justify-center flex-wrap mt-2 gap-2">
                            <button className="group flex justify-center items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25">
                                <Download size={20} />
